for depth in 16 32 64 #128 #width in 128 256 512 1024 2048 #depth in 8 16 #32 64 16 4 #2 4 8 16 32 64
do
    ...
    out_dir="mup_examples/coord_check_shakespeare_char/mup/OPT_2025/adopt_mup_dup_loss/depth${depth}_width${width}_lr${lr}_alpha1-0_seed${seed}"
