for width in 128 256 512 1024 2048 #depth in 2 4 8 16 32 64 128
do
    for lr in  2e-1 2e-2 2e-3 2e-4 2e-5 #2e-8 	
    do
    ...
    out_dir="mup_examples/coord_check_shakespeare_char/mup/OPT_2025/adamw_mup_loss/depth${depth}_width${width}_lr${lr}_seed${seed}"
